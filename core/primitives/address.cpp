...
namespace fc::primitives {
  ...
  Address::Address(Network net, uint64_t id) : network_(net), data_(id) {}

  Address::Address(Network net, Secp256k1PublicKeyHash &&payload) noexcept : network_(net), data_(payload) {}

  Address::Address(Network net, const Secp256k1PublicKeyHash &payload) : network_(net), data_(payload) {}

  Address::Address(Network net, ActorExecHash &&payload) noexcept : network_(net), data_(payload) {}

  Address::Address(Network net, const ActorExecHash &payload) : network_(net), data_(payload) {}

  Address::Address(Network net, BLSPublicKeyHash &&payload) noexcept : network_(net), data_(payload) {}

  Address::Address(Network net, const BLSPublicKeyHash &payload) : network_(net), data_(payload) {}
